...
func (builder *Builder) Delete() (*Builder, error) {
	...
	if !builder.Exists() {
		glog.V(100).Infof("deviceConfig %s namespace %s cannot be deleted because it does not exist",
			builder.Definition.Name, builder.Definition.Namespace)
...
func (builder *Builder) Update(force bool) (*Builder, error) {
	...
	glog.V(100).Infof("Updating the DeviecConfig object named: %s in namespace: %s",
		builder.Definition.Name, builder.Definition.Namespace)
